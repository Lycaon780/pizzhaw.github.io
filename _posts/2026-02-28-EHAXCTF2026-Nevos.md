...
Disassembling `emit_report` revealed the condition to getting the flag. The function checks three 64-bit arguments and only proceeds if they match _"magic"_ constants.
...
- pivot the stack
- jump into `emit_report` _after_ the argument checks
